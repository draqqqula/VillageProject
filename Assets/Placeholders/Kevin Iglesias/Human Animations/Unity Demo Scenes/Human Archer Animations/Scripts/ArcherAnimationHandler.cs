...
namespace KevinIglesias
{
    public class ArcherAnimationHandler : MonoBehaviour
    {
        ...
        [Header("BOW")] public LineRenderer bowstringLine;
        ...
        [Header("ARROW")] public GameObject arrowInHand;
        public GameObject arrowToShoot;

        private IEnumerator getArrowAnimation;

        [Header("UNSHEATHE")] public GameObject bowSheathed;
        ...
        private IEnumerator LoadBowCoroutine(float delay, float duration)
        {
            ...
            Vector3 limb01LoadLocalEulerAngles =
                new Vector3(initialLimb01LocalEulerAngles.x, initialLimb01LocalEulerAngles.y,
                    initialLimb01LocalEulerAngles.z - 15f);
            Vector3 limb02LoadLocalEulerAngles =
                new Vector3(initialLimb02LocalEulerAngles.x, initialLimb02LocalEulerAngles.y,
        ...
        private IEnumerator ShootArrowCoroutine(float delay, float duration)
        {
            ...
            while (t < 1)
            {
                t += Time.deltaTime / duration;
                limb01.localEulerAngles =
                    Vector3.LerpUnclamped(limb01LoadLocalEulerAngles, initialLimb01LocalEulerAngles,
                        bowReleaseCurve.Evaluate(t));
                limb02.localEulerAngles =
                    Vector3.LerpUnclamped(limb02LoadLocalEulerAngles, initialLimb02LocalEulerAngles,
                        bowReleaseCurve.Evaluate(t));

                nockPoint.localPosition = Vector3.LerpUnclamped(initialNockRestLocalPosition,
                    nockPointRestLocalPosition, bowReleaseCurve.Evaluate(t));
        ...
        private IEnumerator CancelLoadBowCoroutine(float delay, float duration)
        {
            ...
            while (t < 1)
            {
                ...
                nockPoint.localPosition =
                    Vector3.LerpUnclamped(initialNockRestLocalPosition, nockPointRestLocalPosition, t);
