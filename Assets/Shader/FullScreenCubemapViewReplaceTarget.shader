Shader "Custom/FullscreenCubemapViewReplaceTarget"
{
    Properties
    {
        _Cube ("Cubemap", CUBE) = "" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            Name "FullscreenCubemapReplaceTargetPass"
            ...
            {
                // Без tolerance. Alpha не сравниваю, чтобы не зависеть
                // от формата cubemap / intermediate RT.
                return
